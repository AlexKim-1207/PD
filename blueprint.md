...
- **Partnership Inquiry Form**: Integrated Formspree contact form for collaboration requests.
...
- **Formspree**: External service integration for handling form submissions without a backend.
- **Persistence**: Theme preference is saved in the browser's local storage.

## Recent Changes
- Added Partnership Inquiry form powered by Formspree.
